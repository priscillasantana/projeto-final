...
export const loadBeerSuccess = (payload: any) =>
  action(BeerTypes.GET_BEERS_SUCCESS, payload);

export const loadBeerFailure = () => action(BeerTypes.GET_BEERS_FAILURE);

// ---------------------------------------------------------------------------------

export const newBeerRequest = (beer: any) =>
  action(BeerTypes.NEW_BEER_REQUEST, beer);

export const newBeerSuccess = (payload: any) =>
  action(BeerTypes.NEW_BEER_SUCCESS, payload);
...
export const deleteBeerRequest = (id: any) =>
  action(BeerTypes.DELETE_BEER_REQUEST, id);
